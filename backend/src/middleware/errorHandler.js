...
export function errorHandler(err, req, res, next) {
  // Not every rejected error is a real JS Error instance with a .stack
  // (Cloudinary's SDK, for example, can reject with a plain object) —
  // logging err.stack alone in that case just prints "undefined" and
  // hides the actual problem. Log everything we've got instead.
